    ...
    internal static class Algorithms
    {
        ...
        private class ArrayRange<T> : ListBase<T>
        {
            ...
            public override void Clear()
            {
                ...
                FillRange(wrappedArray, wrappedArray.Length - count, count, default);
                count = 0;
            }
        ...
        /// <summary>
        /// The class that is used to provide an untyped <see cref="ICollection"/> view onto a typed <see cref="ICollection{T}"/> interface.
        /// </summary>
        [Serializable]
        private class UntypedCollection<T> : ICollection
        {
            ...
            /// <summary>
            /// Create an untyped <see cref="ICollection"/> view onto a typed <see cref="ICollection{T}"/> interface.
            /// </summary>
        ...
        /// implementation of <see cref="IComparable{T}.CompareTo"/> or <see cref="object.Equals"/>.</remarks>
        ...
        /// implementation of <see cref="IComparable{T}.CompareTo"/> or <see cref="object.Equals"/>.</para>
        ...
        /// <param name="collection1">The first collection.</param>
        /// <param name="collection2">The second collection.</param>
        /// <param name="equalityComparer">The <see cref="IEqualityComparer{T}"/> comparer used to compare items for equality. 
        /// Only the Equals and GetHashCode member functions of this interface are called.</param>
        /// <returns>True if <paramref name="collection1"/> are <paramref name="collection2"/> are disjoint, considered as sets.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="collection1"/> or <paramref name="collection2"/> is null.</exception>
        ...
        private static volatile Randomizer myRandomGenerator;
        ...
        private static Randomizer GetRandomGenerator()
        {
            myRandomGenerator ??= Randomizer.GetInstance();
        ...
        public static T[] RandomShuffle<T>(IEnumerable<T> collection, Randomizer randomGenerator)
        {
            ...
            for (int i = count - 1; i >= 1; --i)
            {
                ...
                int j = randomGenerator.GetInt(i + 1);
        ...
        private class CollectionEqualityComparer<T> : IEqualityComparer<IEnumerable<T>>
        {
            ...
            public bool Equals(IEnumerable<T> x, IEnumerable<T> y) => EqualCollections(x, y, equalityComparer);
        ...
        /// </summary>
        /// <remarks>If <paramref name="collection"/> implements <see cref="ICollection{T}"/>, then 
