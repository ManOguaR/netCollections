...
namespace netCollections.Sorted
{
    ...
    public class OrderedMultiDictionary<TKey, TValue> : MultiDictionaryBase<TKey, TValue>, ICloneable
    {
        ...
        public sealed override void Add(TKey key, TValue value)
        {
            ...
            tree.Insert(pair, allowDuplicateValues ? DuplicatePolicy.InsertLast : DuplicatePolicy.ReplaceLast, out KeyValuePair<TKey, TValue> dummy);
        }
        ...
        {
            bool found = tree.Delete(NewPair(key, value), false, out KeyValuePair<TKey, TValue> dummy);
        ...
        {
            return tree.Find(NewPair(key, value), true, false, out KeyValuePair<TKey, TValue> dummy);
        }
        ...
        {
            return (tree.FirstItemInRange(KeyRange(key), out KeyValuePair<TKey, TValue> dummy) >= 0);
        }
        ...
        {
            OrderedMultiDictionary<TKey, TValue> newDict = new(allowDuplicateValues, keyCount, keyComparer, valueComparer, comparer, tree.Clone());
            return newDict;
        }
        ...
        public OrderedMultiDictionary<TKey, TValue> CloneContents()
        {
            ...
            OrderedMultiDictionary<TKey, TValue> newDict = new(allowDuplicateValues, keyComparer, valueComparer);
        ...
        private sealed class KeyValuePairsCollection : ReadOnlyCollectionBase<KeyValuePair<TKey, TValue>>
        {
            ...
            {
                return myDictionary.tree.Find(pair, true, false, out KeyValuePair<TKey, TValue> dummy);
            }
        }
