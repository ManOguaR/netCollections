...
namespace netCollections.Sorted
{
    ...
    public class OrderedBag<T> : CollectionBase<T>, ICloneable
    {
        ...
        {
            OrderedBag<T> newBag = new(comparer, tree.Clone());
            return newBag;
        }
        ...
        public OrderedBag<T> CloneContents()
        {
            ...
            OrderedBag<T> clone = new(comparer);
        ...
        {
            return tree.Delete(item, false, out _);
        }
        ...
        public void IntersectionWith(OrderedBag<T> otherBag)
        {
            ...
            foreach (T item in smaller)
            {
                ...
                if (copiesInSmaller <= copiesInLarger)
                    newTree.Insert(item, DuplicatePolicy.InsertLast, out _);
        ...
        private class ListView : ReadOnlyListBase<T>
        {
            ...
            public sealed override T this[int index]
            {
                get
                {
                    ...
                    {
                        int firstIndex = myBag.tree.FirstItemInRange(rangeTester, out _);
                        int lastIndex = myBag.tree.LastItemInRange(rangeTester, out _);
            ...
            public sealed override int IndexOf(T item)
            {
                ...
                else
                {
                    ...
                    if (reversed)
                    {
                        ...
                        if (indexInSet < 0)
                            return -1;
                        int indexOfEnd = myBag.tree.LastItemInRange(rangeTester, out _);
                    ...
                    else
                    {
                        ...
                        if (indexInSet < 0)
                            return -1;
                        int indexOfStart = myBag.tree.FirstItemInRange(rangeTester, out _);
