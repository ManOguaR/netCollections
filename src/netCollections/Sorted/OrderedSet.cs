namespace netCollections.Sorted
{
    ...
    public class OrderedSet<T> : CollectionBase<T>, ICollection<T>, ICloneable
    {
        ...
        {
            OrderedSet<T> newSet = new(comparer, tree.Clone());
            return newSet;
        }
        ...
        public OrderedSet<T> CloneContents()
        {
            ...
            OrderedSet<T> clone = new(comparer);
        ...
        {
            return tree.Find(item, false, false, out _);
        }
        ...
        {
            return tree.Insert(item, DuplicatePolicy.ReplaceFirst, out _);
        }
        ...
        public void IntersectionWith(OrderedSet<T> otherSet)
        {
            ...
            {
                if (larger.Contains(item))
                    newTree.Insert(item, DuplicatePolicy.ReplaceFirst, out _);
            }
        ...
        private class ListView : ReadOnlyListBase<T>
        {
            ...
            public override T this[int index]
            {
                get
                {
                    ...
                    {
                        int firstIndex = mySet.tree.FirstItemInRange(rangeTester, out _);
                        int lastIndex = mySet.tree.LastItemInRange(rangeTester, out _);
            ...
            public override int IndexOf(T item)
            {
                ...
                else
                {
                    ...
                    if (reversed)
                    {
                        ...
                        if (indexInSet < 0)
                            return -1;
                        int indexOfEnd = mySet.tree.LastItemInRange(rangeTester, out _);
                    ...
                    else
                    {
                        ...
                        if (indexInSet < 0)
                            return -1;
                        int indexOfStart = mySet.tree.FirstItemInRange(rangeTester, out _);
