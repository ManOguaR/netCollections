...
namespace netCollections.Sorted
{
    ...
    public class OrderedDictionary<TKey, TValue> : DictionaryBase<TKey, TValue>, ICloneable
    {
        ...
        {
            OrderedDictionary<TKey, TValue> newDict = new(keyComparer, pairComparer, tree.Clone());
            return newDict;
        }
        ...
        public OrderedDictionary<TKey, TValue> CloneContents()
        {
            ...
            if (!Util.IsCloneableType(typeof(TKey), out bool keyIsValueType))
                NonCloneableType(typeof(TKey));

            if (!Util.IsCloneableType(typeof(TValue), out bool valueIsValueType))
                NonCloneableType(typeof(TValue));

            OrderedDictionary<TKey, TValue> newDict = new(null, keyComparer, pairComparer);
        ...
        public sealed override bool Remove(TKey key)
        {
            ...
            return tree.Delete(keyPair, true, out KeyValuePair<TKey, TValue> item);
        }
        ...
        public bool GetValueElseAdd(TKey key, ref TValue value)
        {
            ...
            bool added = tree.Insert(pair, DuplicatePolicy.DoNothing, out KeyValuePair<TKey, TValue> old);
            if (!added)
                value = old.Value;
            return !added;
        }
        ...
        public sealed override void Add(TKey key, TValue value)
        {
            ...
            bool added = tree.Insert(pair, DuplicatePolicy.DoNothing, out KeyValuePair<TKey, TValue> dummy);
            if (!added)
        ...
        public void Replace(TKey key, TValue value)
        {
            ...
            bool found = tree.Find(pair, true, true, out KeyValuePair<TKey, TValue> dummy);
            if (!found)
        ...
        public sealed override TValue this[TKey key]
        {
            get
            {
                ...
                found = tree.Find(NewPair(key), false, false, out KeyValuePair<TKey, TValue> pairFound);
                if (found)
        ...
        public sealed override bool ContainsKey(TKey key)
        {
            ...
            return tree.Find(NewPair(key), false, false, out KeyValuePair<TKey, TValue> pairFound);
        }
        ...
        public sealed override bool TryGetValue(TKey key, out TValue value)
        {
            ...
            bool found = tree.Find(NewPair(key), false, false, out KeyValuePair<TKey, TValue> pairFound);
        ...
        public class View : DictionaryBase<TKey, TValue>
        {
            ...
            {
                return rangeTester(NewPair(key, default)) == 0;
            }
